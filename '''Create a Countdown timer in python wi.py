...
class CountDown:
    def __init__(self, root):
        ...
        font=('Calisto MT',12), bg="white", fg="black", 
        command=self.Cancel)
    ...
    def start_time(self):
        ...
        while self.time_left > 0:
            ...
            if self.time_left <= 0:
                p = ("timer music.mp3") 
                messagebox.showinfo('Timer Done','Stop Now')
